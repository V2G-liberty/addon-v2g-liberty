...
class RegisterRange(TypedDict):
    """
    A typed dictionary representing a range of Modbus registers to read.
...
class ModbusConfigEntity(TypedDict):
    ...
    Attributes:
        modbus_range (RegisterRange): Configuration for Modbus register access including
